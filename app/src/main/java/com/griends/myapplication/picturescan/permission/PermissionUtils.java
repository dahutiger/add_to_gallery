package com.griends.myapplication.picturescan.permission;
...
public class PermissionUtils {
     ...
     */
    public static PermissionUtils create(Context context, @PermissionConstants.Permission final String... permissions) {
        if(sInstance == null) return new PermissionUtils(context, permissions);
        sInstance.prepare(permissions);
        return sInstance;
    }

    public static PermissionUtils create(Context context) {
        return create(context, new String[]{});
    }
    ...
    private PermissionUtils(Context ctx, final String... permissions) {
        sInstance = this;
        context = ctx;
        prepare(permissions);
    }
